...
| `phyloai pretree convert` | Normalize and convert sequence files before downstream analysis. | Planned: [docs/superpowers/specs/2026-06-11-pretree-convert-design.md](docs/superpowers/specs/2026-06-11-pretree-convert-design.md) |
