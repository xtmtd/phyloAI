...
- **End-to-end dataset**: ~10 genes, ~20 taxa — supports full supermatrix pipeline in minutes
- **Per-step intermediate data**: pre-aligned, pre-trimmed sequences etc. — allows jumping directly to any step without running prior steps
